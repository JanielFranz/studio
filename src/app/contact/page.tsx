    ...
    <main className="flex-grow">
      <section className="container mx-auto px-6 py-24">
        <div className="max-w-4xl">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-black max-w-5xl mx-auto leading-tight text-balance uppercase">
            Open to collaborations, bookings, and mentorship—Markus would love to hear from you.
          </h1>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 pb-24">
        <div className="grid md:grid-cols-2 gap-12">
            <div>
                <p className="text-lg font-bold">Phone: +41 79 123 45 67</p>
                <p className="text-lg font-bold">Email: Markus@Bernhardt.Com</p>
                <p className="text-lg font-bold">Based In Zurich, Switzerland — Working Worldwide</p>
            </div>
            <div>
