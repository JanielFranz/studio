...
export const dictionaries: Dictionaries = {
  en: {
    ...
    'about.paragraph.1': "I'm Janiel Franz, a Peruvian software engineer student with expertise in creating robust, scalable solutions using Domain-Driven Design (DDD) and modern development practices",
  ...
  es: {
    ...
    'about.paragraph.1': 'Soy Janiel Franz, un estudiante de ingenieria de software peruano especializado en crear soluciones robustas y escalables usando Domain-Driven Design (DDD) y prácticas modernas de desarrollo',
